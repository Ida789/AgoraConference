...
import densoftinfotechio.audiocall.openlive.voice.only.model.EngineConfig;
import densoftinfotechio.audiocall.openlive.voice.only.model.MyEngineEventHandler;
...
import densoftinfotechio.audiocall.propeller.Constant;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public boolean checkSelfPermission(String permission, int requestCode) {
        ...
        if (Manifest.permission.RECORD_AUDIO.equals(permission)) {
            ((AgoraApplication) getApplication()).initWorkerThread();
        }
        return true;
    }

    protected RtcEngine rtcEngine() {
        return ((AgoraApplication) getApplication()).getWorkerThread().getRtcEngine();
    }

    protected final WorkerThread worker() {
        return ((AgoraApplication) getApplication()).getWorkerThread();
    }

    protected final EngineConfig config() {
        return ((AgoraApplication) getApplication()).getWorkerThread().getEngineConfig();
    }

    protected final MyEngineEventHandler event() {
        return ((AgoraApplication) getApplication()).getWorkerThread().eventHandler();
    }
    ...
    protected CurrentUserSettings vSettings() {
        return AgoraApplication.mAudioSettings;
    }
