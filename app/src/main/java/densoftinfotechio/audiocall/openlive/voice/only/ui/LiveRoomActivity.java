...
import densoftinfotechio.audiocall.openlive.voice.only.model.AGEventHandler;
...
public class LiveRoomActivity extends BaseActivity implements AGEventHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.audio_broadcast_activity_live_room);
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(LiveRoomActivity.this);
    }
    ...
    private void quitCall() {
        if(sharedPreferences!=null && sharedPreferences.contains("logindoctor")) {
            Intent i = new Intent(LiveRoomActivity.this, DoctorViewActivity.class);
            startActivity(i);
            finish();
        }else{
            Intent i = new Intent(LiveRoomActivity.this, PatientViewActivity.class);
            startActivity(i);
            finish();
        }
