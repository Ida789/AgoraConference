...
import densoftinfotechio.videocall.openlive.ui.ResolutionAdapter;

import static densoftinfotechio.videocall.openlive.Constants.PREF_RESOLUTION_IDX;
...
public class SettingsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.video_broadcast_activity_settings);
