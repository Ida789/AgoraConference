...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    private final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onJoinChannelSuccess(String channel, final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d("Join success, uid: " , (uid & 0xFFFFFFFFL) +"");
                }
            });
        }
        ...
        public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.d("video decoded, uid: ", (uid & 0xFFFFFFFFL) +"");
    ...
    private void showSampleLogs() {
        //Log.dI("Welcome to Agora 1v1 video call");
        //Log.dW("You will see custom logs here");
        //Log.dE("You can also use this to show errors");
    }
    ...
    private void joinChannel() {
        ...
        if(b!=null && b.containsKey("channelname")) {
            channel_name = getIntent().getExtras().getString("channelname");
        }
    ...
    public void onCallClicked(View view) {
        if (mCallEnd) {
            ...
            endCall();
            mCallEnd = true;
            mCallBtn.setImageResource(R.drawable.icon_call);
        }
