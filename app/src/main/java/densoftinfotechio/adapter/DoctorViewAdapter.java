...
public class DoctorViewAdapter extends RecyclerView.Adapter<DoctorViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.tv_patientid.setText(patientModels.get(position).getPatientId());
        //holder.tv_sessiontype.setText(patientModels.get(position).getSessionType());
        holder.tv_sessiontype.setText("Doctor");

        if(patientModels.get(position).getSessionType().equalsIgnoreCase("Text") && patientModels.get(position).getInitiateCall().equalsIgnoreCase("0")){
        ...
        }else if(patientModels.get(position).getSessionType().equalsIgnoreCase("Audio") && patientModels.get(position).getInitiateCall().equalsIgnoreCase("0")){
        ...
        }else if(patientModels.get(position).getSessionType().equalsIgnoreCase("Video") && patientModels.get(position).getInitiateCall().equalsIgnoreCase("0")){
        ...
        if(patientModels.get(position).getInitiateCall().equalsIgnoreCase("1")){
            holder.tv_status.setText("Calling");
            holder.tv_status.setEnabled(false);
        }else if(patientModels.get(position).getInitiateCall().equalsIgnoreCase("2")){
            holder.tv_status.setText("Call Completed");
            holder.tv_status.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.accept, 0);
            holder.tv_status.setEnabled(false);
        }else if(patientModels.get(position).getInitiateCall().equalsIgnoreCase("3")){
